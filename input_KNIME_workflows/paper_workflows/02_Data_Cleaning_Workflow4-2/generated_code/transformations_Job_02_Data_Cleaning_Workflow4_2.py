...
def generateWorkflow():
	...
	binner_Source__input_dataDictionary_transformed=binner_Source__input_dataDictionary_df.copy()
	binner_Source__input_dataDictionary_transformed=data_transformations.transform_derived_field(data_dictionary=binner_Source__input_dataDictionary_transformed,
																  data_type_output = DataType(0),
																  field_in = 'Source', field_out = 'High Longitudes')
	
	binner_Source__output_dataDictionary_df=binner_Source__input_dataDictionary_transformed
