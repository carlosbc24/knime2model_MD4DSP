...
cp /home/carlos/Escritorio/datasets/rowFilterMissing_input_dataDictionary.csv "$(pwd)/data/"output
cp /home/carlos/Escritorio/datasets/rowFilterMissing_output_dataDictionary.csv "$(pwd)/data/"output
cp /home/carlos/Escritorio/datasets/rowFilterMissing_output_dataDictionary.csv "$(pwd)/data/"output
cp /home/carlos/Escritorio/datasets/rowFilterRange_output_dataDictionary.csv "$(pwd)/data/"output
cp /home/carlos/Escritorio/datasets/rowFilterRange_output_dataDictionary.csv "$(pwd)/data/"output
