...
def generateWorkflow():
	...
	if contract_pre_post.check_fix_value_range(value='Asia', is_substring=False, data_dictionary=rowFilterPrimitive_Region__input_dataDictionary_df, belong_op=Belong(0), field='Region',
	...
	if contract_pre_post.check_fix_value_range(value='Asia', is_substring=False, data_dictionary=rowFilterPrimitive_Region__output_dataDictionary_df, belong_op=Belong(0), field='Region',
									quant_abs=None, quant_rel=None, quant_op=None, origin_function="Row Filter"):
